...
export async function createAgreement(
  ...
  // CORREÇÃO: Adicionar creditorId e debtorId para compatibilidade com getAgreementsByUser
  const agreementData = {
    ...data,
    // Campos de relacionamento para queries
    creditorId: currentUserId,        // Freelancer (quem cria o acordo)
    debtorId: data.clientEmail,       // Cliente (email como identificador temporário)
    // Campos legados (mantidos para compatibilidade)
    createdBy: currentUserId,
    userId: currentUserId,
    freelancerId: currentUserId,      // Para compatibilidade com hash e outras funções
    protocol,
    clientAccessToken,
    hash,
    timeline: [],
