...
export default function FreelancerDashboardPage(): React.JSX.Element {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0F172A] text-slate-900 dark:bg-[#0A0F1A] dark:text-slate-100">
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-slate-200 dark:border-slate-700/50/80 bg-white dark:bg-[#111827]/90 dark:bg-[#111827]/90 backdrop-blur-xl dark:border-slate-700/50 dark:bg-[#0A0F1A]/90">
    ...
    {dark ? "☀️" : "🌙"}
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 rounded-2xl border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-[#111827] px-2.5 py-2 shadow-sm dark:shadow-none transition-all hover:border-slate-300 hover:bg-slate-50 dark:bg-[#0F172A] sm:gap-3 sm:px-3"
                >
                ...
                {profileOpen && (
                  <div className="absolute right-0 mt-2 w-72 overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-[#111827] shadow-2xl">
