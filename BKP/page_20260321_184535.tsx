...
export default function PublicAgreementPage() {
  ...
  const reviewMailTo = `mailto:acordos@prejud.com?subject=${encodeURIComponent(
    `Solicitação de revisão - Protocolo ${agreement.protocol}`
  )}&body=${encodeURIComponent(
    `Olá,\n\nSolicito revisão da proposta vinculada ao protocolo ${agreement.protocol}.\n\nTítulo do acordo: ${agreement.title}\n\nDescreva abaixo os ajustes solicitados:\n- \n- \n- \n`
  )}`;
                ...
                <div className="space-y-4">
                  <div className="rounded-2xl border border-amber-200 bg-amber-50 p-4 dark:border-amber-900/40 dark:bg-amber-950/30">
                    ...
                    <p className="mt-2 text-sm leading-6 text-amber-700/90 dark:text-amber-200">
                      Você pode confirmar este acordo, solicitar revisão por
                      e-mail ou contestar o convite.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-3 xl:grid-cols-3">
                    ...
                    <a
                      href={reviewMailTo}
                      className="inline-flex items-center justify-center gap-2 rounded-2xl border border-slate-300 bg-white px-5 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:border-slate-600 dark:bg-[#111827] dark:text-slate-200 dark:hover:bg-[#162033]"
                    >
