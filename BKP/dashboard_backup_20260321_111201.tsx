            ...
            <section className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#0F172A] dark:shadow-none">
              ...
              <div className="grid gap-4 p-5 sm:p-6 md:grid-cols-2">
                {acoesRapidas.map((acao) => {
                  const content = (
                    <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-white hover:shadow-md dark:border-white/10 dark:bg-[#0F172A] dark:shadow-none dark:hover:bg-white/5 dark:hover:shadow-none">
              ...
              <div className="space-y-4 p-4 sm:p-5">
                {data.agreements.length === 0 ? (
                  ...
                  data.agreements.map((acordo: Agreement) => (
                    <article
                      key={acordo.id}
                      className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm transition hover:shadow-md dark:border-white/10 dark:bg-[#111827] dark:shadow-none dark:hover:bg-white/5 dark:hover:shadow-none sm:p-6"
                    >
                      <div className="flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                          <Link
                            href={getAcordoLink(acordo)}
                            className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-slate-900 px-4 py-3 text-sm font-semibold text-white transition hover:bg-slate-800 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100 sm:w-auto"
                          >
            ...
            <section className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#0F172A] dark:shadow-none">
              ...
              <div className="space-y-4 p-5 sm:p-6">
                {cobrancas.map((cobranca) => (
                  <div
                    key={cobranca.id}
                    className="rounded-2xl border border-slate-200 bg-slate-50 p-5 shadow-sm transition-all duration-200 hover:bg-white hover:shadow-md dark:border-white/10 dark:bg-[#0F172A] dark:shadow-none dark:hover:bg-white/5 dark:hover:shadow-none"
                  >
                    <div className="mb-3 flex items-start justify-between gap-3">
                      <div>
                        <h3 className="text-base font-semibold text-slate-900 dark:text-white">
