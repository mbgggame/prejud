                      ...
                      <div className="flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                          <button
                            type="button"
                            disabled
                            className="inline-flex w-full cursor-not-allowed items-center justify-center gap-2 rounded-xl bg-slate-200 px-4 py-3 text-sm font-semibold text-slate-500 opacity-70 dark:bg-white/10 dark:text-slate-300 sm:w-auto"
                          >
                            <MessageCircle className="h-4 w-4" />
                            WhatsApp
                            <ComingSoonBadge />
