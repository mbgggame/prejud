...
function BrazilClock() {
  ...
  return (
    <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-[#111827] px-3 py-1.5 text-xs text-slate-600 shadow-sm dark:shadow-none">
...
function StatCard({
  ...
  const toneMap = {
    ...
    slate: "border-slate-200 dark:border-slate-700/50 bg-slate-50 dark:bg-[#0F172A] text-slate-700",
  };

  return (
    <div className="rounded-2xl border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-[#111827] p-4 shadow-sm dark:shadow-none transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
...
export default function FreelancerDashboardPage(): React.JSX.Element {
  ...
  const getAcordoStatusColor = (status: AcordoStatus | string) => {
    switch (status) {
      case "rascunho":
        return "bg-slate-50 dark:bg-[#0F172A] text-slate-700 border-slate-200 dark:border-slate-700/50";
  ...
  if (error) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-50 dark:bg-[#0F172A]">
        <div className="max-w-md rounded-2xl border border-red-200 bg-white dark:bg-[#111827] p-6 text-center shadow-sm dark:shadow-none">
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0B1120] text-slate-900 dark:bg-[#0A0F1A] dark:text-slate-100">
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-slate-200 dark:border-slate-700/50/80 bg-white dark:bg-[#0F172A] dark:bg-[#111827]/90 dark:bg-[#111827]/90 backdrop-blur-xl dark:border-slate-700/50 dark:bg-[#0A0F1A]/90">
    ...
    {dark ? "☀️" : "🌙"}
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 rounded-2xl border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-[#111827] px-2.5 py-2 shadow-sm dark:shadow-none transition-all hover:border-slate-300 hover:bg-slate-50 dark:bg-[#111827] dark:bg-[#0F172A] sm:gap-3 sm:px-3"
                >
                ...
                {profileOpen && (
                  <div className="absolute right-0 mt-2 w-72 overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-800 dark:border-slate-700/50 bg-white dark:bg-[#111827] shadow-2xl">
                    <div className="border-b border-slate-100 bg-slate-50 dark:bg-[#0F172A] px-4 py-3">
                    ...
                    <div className="py-2">
                      <Link
                        href="/dashboard"
                        className="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-700 transition hover:bg-slate-50 dark:bg-[#0F172A]"
                      >
                        <LayoutList size={16} />
                        Dashboard
                      </Link>
      ...
      <main className="mx-auto max-w-7xl px-4 pt-28 pb-8 sm:px-6 sm:pt-32 lg:px-8 lg:pt-36">
        <section className="relative overflow-hidden rounded-[28px] border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-[#111827] shadow-sm dark:shadow-none dark:border-slate-700/50 dark:bg-[#111827]">
          ...
          <div className="relative p-5 sm:p-6 lg:p-8">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              ...
              <div className="w-full max-w-xl rounded-3xl border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-[#111827]/90 dark:bg-[#111827]/90 p-4 shadow-sm dark:shadow-none backdrop-blur sm:p-5 lg:max-w-md">
                <div className="flex items-start gap-3">
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-slate-200 dark:border-slate-700/50 bg-slate-50 dark:bg-[#0F172A]">
        ...
        <section className="mt-6 grid gap-6 space-y-6">
          <div className="space-y-6">
            <section className="overflow-hidden rounded-[28px] border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-[#111827] shadow-sm dark:shadow-none dark:border-slate-700/50 dark:bg-[#111827]">
              <div className="flex flex-col gap-3 border-b border-slate-100 px-5 py-5 sm:px-6 sm:py-6 md:flex-row md:items-center md:justify-between">
                ...
                <span className="inline-flex w-fit items-center rounded-full border border-slate-200 dark:border-slate-700/50 bg-slate-50 dark:bg-[#0F172A] px-3 py-1 text-xs font-semibold text-slate-600">
              ...
              <div className="grid gap-4 p-5 sm:p-6 md:grid-cols-2">
                {acoesRapidas.map((acao) => {
                  const content = (
                    <div className="rounded-2xl border border-slate-200 dark:border-slate-700/50 bg-slate-50 dark:bg-[#0F172A] p-5 shadow-sm dark:shadow-none transition-all duration-200 hover:-translate-y-0.5 hover:bg-white dark:bg-[#111827] hover:shadow-md">
                      <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-[#111827]">
              ...
              <div className="space-y-4 p-4 sm:p-5">
                {data.agreements.length === 0 ? (
                  ...
                  data.agreements.map((acordo: Agreement) => (
                    <article key={acordo.id} className="rounded-3xl border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-[#111827] p-5 shadow-sm dark:shadow-none transition hover:shadow-md sm:p-6">
                      <div className="flex flex-col gap-5">
                        <div className="flex flex-col gap-4 border-b border-slate-100 pb-5 lg:flex-row lg:items-start lg:justify-between">
                          <div className="flex items-start gap-4">
                            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-slate-200 dark:border-slate-700/50 bg-slate-50 dark:bg-[#0F172A]">
                          ...
                          <Link
                            ...
                            className="inline-flex w-fit items-center gap-2 rounded-xl border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-[#111827] px-3.5 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:bg-[#0F172A] hover:text-slate-900"
                          >
                            Ver detalhes
                            <ArrowRight className="h-4 w-4" />
                          </Link>
                        ...
                        <div className="grid gap-4 rounded-2xl bg-slate-50 dark:bg-[#0F172A] p-4 sm:grid-cols-2 lg:grid-cols-3 mt-4">
                          <div>
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                          ...
                          <button
                            ...
                            className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white dark:bg-[#111827] px-4 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:bg-[#0F172A] sm:w-auto"
                          >
            ...
            <section className="overflow-hidden rounded-[28px] border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-[#111827] shadow-sm dark:shadow-none dark:border-slate-700/50 dark:bg-[#111827]">
              ...
              <div className="space-y-4 p-5 sm:p-6">
                {cobrancas.map((cobranca) => (
                  <div
                    key={cobranca.id}
                    className="rounded-2xl border border-slate-200 dark:border-slate-700/50 bg-slate-50 dark:bg-[#0F172A] p-5 shadow-sm dark:shadow-none transition-all duration-200 hover:bg-white dark:bg-[#111827] hover:shadow-md"
                  >
                    <div className="mb-3 flex items-start justify-between gap-3">
                      <div>
                        <h3 className="text-base font-semibold text-slate-900">
