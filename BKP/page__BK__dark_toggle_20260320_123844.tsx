...
function BrazilClock() {
  ...
  return (
    <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 dark:border-slate-800 bg-white px-3 py-1.5 text-xs text-slate-600 shadow-sm">
...
function StatCard({
  ...
  return (
    <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white p-4 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
...
export default function FreelancerDashboardPage(): React.JSX.Element {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-800/60 text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-slate-200 dark:border-slate-800/80 bg-white/90 backdrop-blur-xl dark:border-slate-800 dark:bg-slate-950/90">
  ...
  />
            ...
            <div className="flex items-center gap-2">
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white px-2.5 py-2 shadow-sm transition-all hover:border-slate-300 hover:bg-slate-50 dark:bg-slate-800/60 sm:gap-3 sm:px-3"
                >
                ...
                {profileOpen && (
                  <div className="absolute right-0 mt-2 w-72 overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-white shadow-2xl">
      ...
      <main className="mx-auto max-w-7xl px-4 pt-28 pb-8 sm:px-6 sm:pt-32 lg:px-8 lg:pt-36">
        <section className="relative overflow-hidden rounded-[28px] border border-slate-200 dark:border-slate-800 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <div className="relative p-5 sm:p-6 lg:p-8">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              ...
              <div className="w-full max-w-xl rounded-3xl border border-slate-200 dark:border-slate-800 bg-white/90 p-4 shadow-sm backdrop-blur sm:p-5 lg:max-w-md">
        ...
        <section className="mt-6 grid gap-6 space-y-6">
          <div className="space-y-6">
            <section className="overflow-hidden rounded-[28px] border border-slate-200 dark:border-slate-800 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
              ...
              <div className="grid gap-4 p-5 sm:p-6 md:grid-cols-2">
                {acoesRapidas.map((acao) => {
                  const content = (
                    <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/60 p-5 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-white hover:shadow-md">
                      <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl border border-slate-200 dark:border-slate-800 bg-white">
              ...
              <div className="space-y-4 p-4 sm:p-5">
                {data.agreements.length === 0 ? (
                  ...
                  data.agreements.map((acordo: Agreement) => (
                    <article key={acordo.id} className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white p-5 shadow-sm transition hover:shadow-md sm:p-6">
                      <div className="flex flex-col gap-5">
                        <div className="flex flex-col gap-4 border-b border-slate-100 pb-5 lg:flex-row lg:items-start lg:justify-between">
                          ...
                          <Link
                            ...
                            className="inline-flex w-fit items-center gap-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-white px-3.5 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:bg-slate-800/60 hover:text-slate-900"
                          >
                            Ver detalhes
                            <ArrowRight className="h-4 w-4" />
                          </Link>
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                          ...
                          <button
                            ...
                            className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:bg-slate-800/60 sm:w-auto"
                          >
            ...
            <section className="overflow-hidden rounded-[28px] border border-slate-200 dark:border-slate-800 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
              ...
              <div className="space-y-4 p-5 sm:p-6">
                {cobrancas.map((cobranca) => (
                  <div
                    key={cobranca.id}
                    className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/60 p-5 shadow-sm transition-all duration-200 hover:bg-white hover:shadow-md"
                  >
                    <div className="mb-3 flex items-start justify-between gap-3">
                      <div>
                        <h3 className="text-base font-semibold text-slate-900">
