...
export function mapAgreementToContractInput(agreement: Agreement): ContractProtocolInput {
  return {
    ...
    freelancer_document: (agreement as any).freelancerDocument || '',

    client_name: agreement.clientName || '',
    client_document: (agreement as any).clientDocument || '',
    ...
    city: (agreement as any).freelancerCity || '',
    state: (agreement as any).freelancerState || '',
